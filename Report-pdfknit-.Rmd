...
With the advancement of science in the 19th and 20th century, it was discovered that suicidal tendencies are caused by biological factors as well and hence, continents like Europe and North America revoked the laws regarding criminalize suicide.

Further, as the years went by, and awareness increased, lot of policies came into action, like Convention on the Rights of Persons with Disabilities and World Health Organization Mental Health Action Plan 2020--2030 prompted various countries to decriminalize suicide
...
In the special report, 8 perspectives were decided to be discussed, out of which initial visualizations were created, global/generic and related to a particular article and then the '360themes' package was added to the selected ones.
