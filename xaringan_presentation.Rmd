...
- The interfact for all articles is different, so it did not make sense to put this on one page or front page.
...
- A combination of 4 data sets have been used for this visualization, two census datas for population count, police shootings database from Washington post, which was extracted from github and a states code dataset to combine the three datasets.
