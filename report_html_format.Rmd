...
The plot below highlights the states where the average police shooting rate is the highest from 2015-2022.

```{r p4, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Killing rate: USA: 2015-2022", fig.height=5, fig.width=5}

plot5_shootings <- shots_usa_plot4 |>
...
```{r p5, echo=FALSE, message=FALSE, warning=FALSE, fig.height=6, fig.width=6, fig.cap="Visualization 5-India: States with higehst regestered cases"}
...
```{r p6, echo=FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=5, fig.cap="Visualization 6- Registered Cases vs Police Arrested: Karnataka"}
...
```{r p7, echo=FALSE, message=FALSE, warning=FALSE, fig.height=5, fig.width=6, fig.cap="Europe: Relation b/w GDP per capita & Trust in Police"}
ggplot(
  europe_trust_in_police,
...
This graph shows that the trust in police is proportional to the GDP per capita. Hence, it can be said that countries falling under higher human development index, have less cases of misconducts and people trust the police more or the people themselves have some influence on the misconduct done by the police and hence, the trust.
...
```{r p8, echo=FALSE, message=FALSE, warning=FALSE, fig.height=5, fig.width=6, fig.cap="Phillippines Drug War Police Killings"}
...
The plot here shows the perception of people regarding corruption against these institutions plotted on the graph. And it is clearly seen that, almost each year, people have believed the Police to be the most corrupt.
...
```{r plot9, echo=FALSE, message=FALSE, warning=FALSE, out.width='90%', fig.cap="People Survey: High Corruption Scams"}
plot_police <-
...
To tackle the problem of the missing year, a dumbbell plot was thought of to highlight the concern better.

```{r plot10,  echo=FALSE, message=FALSE, warning=FALSE, fig.height=6, fig.width=7, fig.cap="Perception of Corruption vs Institution"}
world_owid_police <-
  read_csv("data/policingthepolice/perception-of-corruption-by-institution.csv") |>
  filter(Entity == "World") |>
...
Since the previous dumbbell plot code used 'library(dumbbell)' which was hard to integrate in the publication code, a dumbbell plot with 'ggplot' was made.
...
```{r plot11,  echo=FALSE, message=FALSE, warning=FALSE, out.width='90%', fig.cap="CORRUPTION SURVEY"}
plot11_viz <- plot11 |>
