...
```{r}
# one <- join %>% filter(y== "HIGH HUMAN DEVELOPMENT") %>% head(10)
# two <- join %>% filter(y== "VERY HIGH HUMAN DEVELOPMENT") %>% head(10)
# three <- join %>% filter(y== "MEDIUM HUMAN DEVELOPMENT")%>% head(10)
```
