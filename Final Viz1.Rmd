...
1. How to correct the overlapping
2. Add 360 theme
3. Help needed with colouring according to range.

# Visualization for India NCRB Data 
*(Use Webscraping to extract data from .pdf)*
