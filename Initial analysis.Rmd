...
plot_nepal <- ggplot(nepal, aes(x = Year, y = `Deaths - Self-harm - Sex: Both - Age: Age-standardized (Rate)`)) +
  ...
  labs(
    ...
    subtitle="Suicide rates in Nepal have fallen by about one third over the last 20 years",
    caption = paste(
  ...
  theme( panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank() )+
    annotate_360_light(x = 2015, y = 20, label = "There is a significant increase
                 in the suicide rate in 2017
                 where India also introducted its
                 Mental Healthcare Act 2017",hjust=1, size=7)

save_360plot(plot, "indiatimeseries.png")
